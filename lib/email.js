...
export async function sendPriceDropAlert(userEmail, product, oldPrice, newPrice) {
  const resend = new Resend(process.env.RESEND_API_KRY)
    ...
    const {data,error} = await resend.emails.send({
        ...
        <html>
          ...
          <body style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, 'Helvetica Neue', Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
            ...
            <div style="background: linear-gradient(135deg, #0f172a 0%, #334155 100%); padding: 30px; border-radius: 10px 10px 0 0; text-align: center;">
            ...
            <div style="background: #ffffff; padding: 30px; border: 1px solid #e5e7eb; border-top: none; border-radius: 0 0 10px 10px;">
              ...
              <div style="background: #f8fafc; border-left: 4px solid #334155; padding: 15px; margin: 20px 0; border-radius: 4px;">
              ...
              <table style="width: 100%; margin: 20px 0;">
                ...
                <tr>
                  <td style="padding: 10px;">
                    ...
                    <div style="font-size: 32px; color: #0f172a; font-weight: bold;">
              ...
              <div style="text-align: center; margin: 30px 0;">
                <a href="${product.url}" 
                   style="display: inline-block; background: #0f172a; color: white; padding: 14px 30px; text-decoration: none; border-radius: 6px; font-weight: 600; font-size: 16px;">
                  View Product →
                </a>
              </div>
              
              <div style="border-top: 1px solid #e5e7eb; padding-top: 20px; margin-top: 20px; text-align: center; color: #6b7280; font-size: 12px;">
                <p>You're receiving this email because you're tracking this product on TrackMyPrice.</p>
